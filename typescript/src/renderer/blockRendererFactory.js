  ...
  const blockComponents = {
    ...
    BulletedListBlock: ({ block, renderChildren }) =>
      createElement('div', {
        ...
        createElement('div', { key: 'content', className: 'notion-list-content' }, [
          createElement('div', {
            key: 'bullet',
          ...
          }, renderRichText(block.bulleted_list_item?.rich_text || [], createElement))
        ]),
        renderChildren()
      ]),
      ...
      return createElement('div', {
        ...
        createElement('div', { key: 'content', className: 'notion-list-content' }, [
          ...
          createElement('div', { 
            key: 'text',
            className: 'notion-list-item-text'
          }, renderRichText(block.numbered_list_item?.rich_text || [], createElement))
        ]),
        renderChildren()
      ]);
    },
    ...
    CodeBlock: ({ block, renderChildren }) =>
      createElement('div', {
        ...
        createElement('div', { key: 'language' }, block.code?.language || 'Plain Text'),
        createElement('pre', { key: 'code' }, 
          createElement('code', {}, renderRichText(block.code?.rich_text || [], createElement))
        ),
        renderChildren()
      ]),
    ...
    QuoteBlock: ({ block, renderChildren }) =>
      createElement('div', {
        ...
        createElement('blockquote', { key: 'quote' },
    ...
    ImageBlock: ({ block, renderChildren }) => {
      ...
      return createElement('div', {
        ...
        createElement('div', { key: 'image-placeholder', className: 'notion-image-placeholder' }),
        imageData?.caption && createElement('div', { 
          key: 'caption',
    ...
    TableBlock: ({ block, renderChildren, depth, renderBlock }) =>
      createElement('div', {
        ...
        createElement('table', { key: 'table', className: 'notion-table' }, [
          block.table?.has_column_header && createElement('thead', { key: 'thead' },
    ...
    ColumnBlock: ({ block, renderChildren, parentType }) => 
      parentType === 'column_list' ? createElement('div', {
    ...
    ToggleBlock: ({ block, renderChildren }) =>
      createElement('div', {
        ...
        createElement('div', { key: 'content', className: 'notion-toggle-content' }, [
          createElement('span', { key: 'arrow', className: 'notion-toggle-arrow' }, '▶'),
          createElement('span', { 
            key: 'text',
    ...
    UnsupportedBlock: ({ block, renderChildren }) =>
      createElement('div', {
        ...
        createElement('span', { key: 'text' }, `Unsupported block type: ${block?.type}`),
        renderChildren()
      ])
  };
