...
export const ColumnListBlockRenderer: React.FC<ColumnListBlockRendererProps> = ({ 
  block, 
  depth = 0 
}) => {
  return (
    <div className="notion-selectable notion-column_list-block" data-block-id={block.id}>
      <div className="notion-column-list" style={{ display: 'flex', gap: '16px' }}>
